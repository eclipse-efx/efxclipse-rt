...
class MinMaxAddonUtil {
	...
	public static void addChildrenOfMinMaxChildrenAreaToRestoreList(EModelService modelService, MUIElement element,
		...
		for (MPlaceholder placeholder : areas) {
			...
			List<MPartStack> partStacks = modelService.findElements(placeholder, null, MPartStack.class, null);
	 ...
	 */
	public static void restoreStacksOfMinMaxChildrenArea(final MinMaxAddonWithPartialRestore minMaxAddon, MUIElement element,
	 ...
	 *            The MUIElement being restored.
	 */
	public static void maximizeMinMaxChildrenArea(final MinMaxAddonWithPartialRestore minMaxAddon, final MUIElement element) {
		if (element instanceof MPartStack) {
			MArea area = getAreaFor((MPartStack) element);
			if (area != null && area.getTags().contains(MIN_MAXIMIZEABLE_CHILDREN_AREA_TAG)) {
	 ...
	 *
	 * @param minMaxAddon
	 *            The {@link MinMaxAddonWithPartialRestore} calling
	 * @param element
	 *            The {@link MUIElement} being unzoomed
	 */
	public static void unzoomStackOfMinMaxChildrenArea(final MinMaxAddonWithPartialRestore minMaxAddon, final MUIElement element) {
		if (element instanceof MPartStack) {
			MArea area = getAreaFor((MPartStack) element);
			if (area != null && area.getTags().contains(MIN_MAXIMIZEABLE_CHILDREN_AREA_TAG)) {
				final MPlaceholder placeholder = area.getCurSharedRef();
