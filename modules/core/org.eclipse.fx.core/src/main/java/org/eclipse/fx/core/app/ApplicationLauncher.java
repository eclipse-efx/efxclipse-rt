/*******************************************************************************
 * Copyright (c) 2016 BestSolution.at and others. All rights reserved. This
...
// }
//
// public static CompletableFuture<ExitStatus> start(Map<String, Object>
// parameters) {
// if( parameters.containsKey("application") ) {
// String appId = (String) parameters.get("application");
// Optional<Application> application =
// ServiceUtils.getServiceReferenceList(Application.class)
// .stream()
...
// } else {
// throw new IllegalStateException("No application with id '"+appId+"' is
// available.");
// }
// } else {
