 ...
 * <ul>
 *   <li>{@link org.eclipse.fx.code.compensator.hsl.hSL.impl.ScannerMultiLineRuleImpl#getStartSeq <em>Start Seq</em>}</li>
 *   <li>{@link org.eclipse.fx.code.compensator.hsl.hSL.impl.ScannerMultiLineRuleImpl#getEndSeq <em>End Seq</em>}</li>
 *   <li>{@link org.eclipse.fx.code.compensator.hsl.hSL.impl.ScannerMultiLineRuleImpl#getEscapeSeq <em>Escape Seq</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ScannerMultiLineRuleImpl extends ScannerRuleImpl implements ScannerMultiLineRule
{
  /**
   ...
   * @generated
   */
  protected ScannerMultiLineRuleImpl()
  {
    super();
  }
  ...
  {
    return HSLPackage.Literals.SCANNER_MULTI_LINE_RULE;
  }
  ...
  public void setStartSeq(String newStartSeq)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HSLPackage.SCANNER_MULTI_LINE_RULE__START_SEQ, oldStartSeq, startSeq));
  }
  ...
  public void setEndSeq(String newEndSeq)
  {
    ...
    endSeq = newEndSeq;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HSLPackage.SCANNER_MULTI_LINE_RULE__END_SEQ, oldEndSeq, endSeq));
  }
  ...
  public void setEscapeSeq(String newEscapeSeq)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HSLPackage.SCANNER_MULTI_LINE_RULE__ESCAPE_SEQ, oldEscapeSeq, escapeSeq));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HSLPackage.SCANNER_MULTI_LINE_RULE__START_SEQ:
        return getStartSeq();
      case HSLPackage.SCANNER_MULTI_LINE_RULE__END_SEQ:
        return getEndSeq();
      case HSLPackage.SCANNER_MULTI_LINE_RULE__ESCAPE_SEQ:
        return getEscapeSeq();
    }
