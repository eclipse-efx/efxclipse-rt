 ...
 * <ul>
 *   <li>{@link org.eclipse.fx.code.compensator.hsl.hSL.impl.PartitionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PartitionImpl extends MinimalEObjectImpl.Container implements Partition
{
  ...
  {
    return HSLPackage.Literals.PARTITION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HSLPackage.PARTITION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case HSLPackage.PARTITION__NAME:
        return getName();
    }
