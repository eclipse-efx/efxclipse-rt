...
public class JavaScriptDocScanner extends JavaScriptCommentScanner {
	...
	public JavaScriptDocScanner() {
		super(IJavaScriptColorConstants.JAVADOC_DEFAULT, fgTokenProperties);
	}
	...
	protected List<IRule> createRules() {
		...
		token= getToken(IJavaScriptColorConstants.JAVADOC_DEFAULT);
