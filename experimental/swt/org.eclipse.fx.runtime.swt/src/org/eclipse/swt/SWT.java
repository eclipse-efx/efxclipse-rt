...
public class SWT {
	...
	static {
		...
		*/
		...
		if ("carbon".equals (platform) || "cocoa".equals (platform) || ("javafx".equals(platform) && System.getProperty("os.name").equals("Mac OS X") )) { //$NON-NLS-1$ //$NON-NLS-2$
			MOD1 = COMMAND;
			MOD2 = SHIFT;
			MOD3 = ALT;
			MOD4 = CONTROL;
	...
	public static String getPlatform () {
		return "javafx";//FIXME Platform.PLATFORM;
	}
