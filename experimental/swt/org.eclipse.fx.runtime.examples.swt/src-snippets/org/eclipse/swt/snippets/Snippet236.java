...
public class Snippet236 implements SWTAppStart {

	@Override
	public BlockCondition createApp(Display display) {
		Shell shell = new Shell(display);
		shell.setText("(JavaFX) Table: Change style multiple times in cell");
		...
		TextStyle style1 = new TextStyle(font1,
				display.getSystemColor(SWT.COLOR_BLUE), null);
		TextStyle style2 = new TextStyle(font2,
				display.getSystemColor(SWT.COLOR_MAGENTA), null);
		TextStyle style3 = new TextStyle(font3,
	...
	public static void main(String[] args) {
		SWTUtil.getInstance().bootstrap(new Snippet236());
	}
}
