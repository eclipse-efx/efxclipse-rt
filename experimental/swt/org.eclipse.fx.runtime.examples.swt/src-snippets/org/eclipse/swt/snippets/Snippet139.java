...
public class Snippet139 implements SWTAppStart {
	...
	public org.eclipse.fx.runtime.swtutil.SWTUtil.BlockCondition createApp(
			Display display) {
	...
	public static void main(String[] args) {
		SWTUtil.getInstance().bootstrap(new Snippet139());
	}
}
