...
public final class GsonPartitionRule_DynamicEndImpl implements GsonBase, PartitionRule_DynamicEnd, PartitionRule {
	...
	public GsonPartitionRule_DynamicEndImpl(String beginMatch, String beginPrefix, Check check, Condition condition, String endTemplate) {
	...
	public static class Builder implements PartitionRule_DynamicEnd.Builder {
		...
		public PartitionRule_DynamicEnd build() {
			return new GsonPartitionRule_DynamicEndImpl(beginMatch, beginPrefix, check, condition, endTemplate);
		}
	}
}
