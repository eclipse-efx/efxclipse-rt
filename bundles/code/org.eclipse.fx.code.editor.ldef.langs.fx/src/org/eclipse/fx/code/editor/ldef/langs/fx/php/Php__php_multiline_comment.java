...
public class Php__php_multiline_comment extends org.eclipse.jface.text.rules.RuleBasedScanner {
	public Php__php_multiline_comment() {
		org.eclipse.jface.text.rules.Token php_doc_defaultToken = new org.eclipse.jface.text.rules.Token(new org.eclipse.jface.text.TextAttribute("php.php_doc_default"));
