...
public class AdocPartitionScanner extends org.eclipse.jface.text.rules.RuleBasedPartitionScanner {
	public AdocPartitionScanner() {
		...
		pr[0] = new org.eclipse.fx.text.PredicateColumnStartRule(new org.eclipse.jface.text.rules.MultiLineRule(
			  "////"
			, "////"
		...
		pr[1] = new org.eclipse.fx.text.PredicateColumnStartRule(new org.eclipse.jface.text.rules.SingleLineRule(
			  "//"
			, null
		...
		pr[2] = new org.eclipse.fx.text.PredicateColumnStartRule(new org.eclipse.jface.text.rules.SingleLineRule(
			  "* "
			, null
		...
		pr[3] = new org.eclipse.fx.text.PredicateColumnStartRule(new org.eclipse.jface.text.rules.MultiLineRule(
			  "----"
			, "----"
		...
		pr[4] = new org.eclipse.fx.text.PredicateColumnStartRule(new org.eclipse.jface.text.rules.MultiLineRule(
			  "...."
			, "...."
