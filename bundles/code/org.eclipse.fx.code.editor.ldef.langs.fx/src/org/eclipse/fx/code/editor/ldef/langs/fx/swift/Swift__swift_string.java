...
public class Swift__swift_string extends org.eclipse.jface.text.rules.RuleBasedScanner {
	public Swift__swift_string() {
		org.eclipse.jface.text.rules.Token swift_stringToken = new org.eclipse.jface.text.rules.Token(new org.eclipse.jface.text.TextAttribute("swift.swift_string"));
