...
public class Groovy__groovy_apidoc extends org.eclipse.jface.text.rules.RuleBasedScanner {
	public Groovy__groovy_apidoc() {
		org.eclipse.jface.text.rules.Token groovy_api_doc_defaultToken = new org.eclipse.jface.text.rules.Token(new org.eclipse.jface.text.TextAttribute("groovy.groovy_api_doc_default"));
