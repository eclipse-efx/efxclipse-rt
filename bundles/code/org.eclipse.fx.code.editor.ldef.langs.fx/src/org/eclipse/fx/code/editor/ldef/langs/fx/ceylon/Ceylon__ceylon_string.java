...
public class Ceylon__ceylon_string extends org.eclipse.jface.text.rules.RuleBasedScanner {
	public Ceylon__ceylon_string() {
		org.eclipse.jface.text.rules.Token ceylon_stringToken = new org.eclipse.jface.text.rules.Token(new org.eclipse.jface.text.TextAttribute("ceylon.ceylon_string"));
