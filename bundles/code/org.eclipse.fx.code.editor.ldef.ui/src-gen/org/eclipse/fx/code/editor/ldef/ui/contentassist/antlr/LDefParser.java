		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScanner_SingleLineRuleAccess().getEnabledIfAssignment_5_1(), "rule__Scanner_SingleLineRule__EnabledIfAssignment_5_1");
					...
					put(grammarAccess.getScanner_MultiLineRuleAccess().getEnabledIfAssignment_6_1(), "rule__Scanner_MultiLineRule__EnabledIfAssignment_6_1");
