...
public class ExtendedPatternRule implements IPredicateRule {
	 ...
	 */
	public ExtendedPatternRule(String startSequence, String endSequence, IToken token, char escapeCharacter, boolean breaksOnEOL) {
	 ...
	 * @since 2.1
	 */
	public ExtendedPatternRule(String startSequence, String endSequence, IToken token, char escapeCharacter, boolean breaksOnEOL, boolean breaksOnEOF) {
	 ...
	 * @since 3.0
	 */
	public ExtendedPatternRule(String startSequence, String endSequence, IToken token, char escapeCharacter, boolean breaksOnEOL, boolean breaksOnEOF, boolean escapeContinuesLine) {
	...
	protected boolean endSequenceDetected(ICharacterScanner scanner) {
		...
		while ((c= scanner.read()) != ICharacterScanner.EOF) {
			if (c == fEscapeCharacter) {
				...
				if (sequenceEndDetected(scanner, fEndSequence, fBreaksOnEOF))
					return true;
	...
	protected boolean sequenceEndDetected(ICharacterScanner scanner, char[] sequence, boolean eofAllowed) {
	 ...
	 */
	protected final boolean sequenceDetected(ICharacterScanner scanner, char[] sequence, boolean eofAllowed) {
