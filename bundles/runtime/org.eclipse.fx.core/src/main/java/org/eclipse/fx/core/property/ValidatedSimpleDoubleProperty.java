...
/**
 * A validated property using {@link DoubleProperty}
 *
 * @since 2.4.0
 */
public class ValidatedSimpleDoubleProperty extends ValidatedPropertyBase<Number> implements ValidatedDoubleProperty {
	 ...
	 *            the domain property
	 */
	public ValidatedSimpleDoubleProperty(DoubleProperty domainProperty) {
		super(domainProperty);
	}

	@Override
	public DoubleProperty bindProperty() {
		return (DoubleProperty) this.domainProperty;
	}
}